...
const BathroomRemodelingPortfolio = ({ pastProjects }) => {
  return (
        ...
        <div className={styles.hero_header_container}>
          <div className={styles.header_content}>
            <Typography variant="h1">
              Bathroom Remodeling Jobs Portfolio
            </Typography>
...
export async function getStaticProps() {
  const query = `*[_type == "projects" && jobType[0].label == "Bathroom Remodel"]`;
...
export default BathroomRemodelingPortfolio;
